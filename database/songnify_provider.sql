...
--
-- Host: localhost    Database: songnify
-- ------------------------------------------------------
...
CREATE TABLE `provider` (
  ...
  PRIMARY KEY (`comp_id`),
  UNIQUE KEY `company_name` (`comp_name`),
  UNIQUE KEY `comp_ea` (`comp_ea`),
  UNIQUE KEY `comp_username` (`comp_username`)
...
-- Dump completed on 2018-05-08 18:06:24
